...
class AhmedMLForceRegressor(PointCloudSetPredictor):
    ...
    **kwargs,
    ...
    if backbone == "pointnext":
        ...
        if weight_mode != "uniform":
            raise ValueError("AhmedML PointNeXt uses the original uniform neighborhood reduction.")
    ...
    raise ValueError(f"Unsupported AhmedML backbone: {backbone}")
