...
from case_studies.airfrans_field_prediction.dataset import AirfRANSForceDataset, SAMPLING_MODES
...
def build_dataset_from_config(dataset_config: dict) -> AirfRANSForceDataset:
    return AirfRANSForceDataset(
        processed_root=dataset_config["processed_root"],
        task=dataset_config.get("task", "full"),
