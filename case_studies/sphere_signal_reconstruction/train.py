...
from case_studies.sphere_signal_reconstruction.benchmark import save_training_artifacts, train_reconstructor
from case_studies.sphere_signal_reconstruction.common import DEFAULT_EVAL_MODES, set_random_seed
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the sphere signal reconstruction benchmark.")
    parser.add_argument("--output_dir", default=str(REPO_ROOT / "checkpoints" / "sphere_signal_reconstruction" / "run"))
    ...
    parser.add_argument(
        "--weight_mode",
        choices=["uniform", "knn", "oracle_density", "voronoi_oracle"],
        default="uniform",
    )
