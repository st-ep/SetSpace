...
def parse_args():
    parser = argparse.ArgumentParser(description="Train the point-cloud mean-regression benchmark.")
    parser.add_argument("--output_dir", default=str(REPO_ROOT / "checkpoints" / "point_cloud_mean_regression" / "run"))
